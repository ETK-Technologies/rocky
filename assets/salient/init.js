(function ($, window, document) {
  ...
  var $window = $(window),
    ...
    condenseHeaderLayout = $headerOuterEl.is('[data-condense="true"]')
      ? !0
      : !1,
    usingLogoImage = $headerOuterEl.is('[data-using-logo="1"]') ? !0 : !1,
    headerResize = $headerOuterEl.is('[data-header-resize="1"]') ? !0 : !1,
    headerTransparent = $headerOuterEl.is('[data-transparent-header="true"]')
      ? !0
      : !1,
    headerMobileFixed = $headerOuterEl.is('[data-mobile-fixed="1"]') ? !0 : !1,
    ...
    $tabbedClickCount = 0,
    $fullscreenSelector = "",
    $fullscreenMarkupBool = !1,
    $bodyBorderHeaderColorMatch = !1,
    nectarBoxRoll = { animating: "false", perspect: "not-rolled" },
    $nectarFullPage = { $usingFullScreenRows: !1 },
    $svgResizeTimeout,
  ...
  var nectarDOMInfo = {
    usingMobileBrowser: navigator.userAgent.match(
      ...
      ? !0
      : !1,
    usingFrontEndEditor: typeof window.vc_iframe === "undefined" ? !1 : !0,
    ...
    init: function () {
      ...
      this.usingFrontEndEditor =
        typeof window.vc_iframe === "undefined" ? !1 : !0;
    },
  };
  ...
  function flexsliderInit() {
    $(".flex-gallery").each(function () {
      ...
      imagesLoaded($(this), function () {
        var autorotate = $that.find("ul").is('[data-d-autorotate="true"]')
          ? !1
          : !0;
        $that.flexslider({
          animation: "fade",
  ...
  NectarIconMouseFollow.prototype.viewportTracking = function () {
    ...
    if ("IntersectionObserver" in window) {
      var options = { rootMargin: "0px", threshold: 0 };
      this.observer = new IntersectionObserver(function (entries) {
        entries.forEach(function (entry) {
          if (entry.isIntersecting) {
            that.$el.addClass("active");
            that.$el.find(that.bgElSelector).css("visibility", "visible");
            that.activeViewRAF = !0;
          } else {
            that.$el.find(that.bgElSelector).css("visibility", "hidden");
            that.activeViewRAF = !1;
          }
        });
      }, options);
  ...
  NectarIconMouseFollow.prototype.mouseBind = function () {
    ...
    if (this.iconType === "horizontal-movement") {
      that.$el.find(".flickity-viewport").on("mouseenter", function () {
        ...
        var $iconColor = that.$el.is("[data-touch-icon-color]")
          ? "color-" + that.$el.attr("data-touch-icon-color")
          : "";
        that.$dragEl
  ...
  function flickityInit() {
    ...
    $(".nectar-flickity:not(.masonry)").each(function (i) {
      ...
      var $flickity_autoplay = !1;
      var $flickity_stored_autoplay = !1;
      if (
      ...
      var $that = $(this);
      var $frontEndEditorDrag = $("body.vc_editor").length > 0 ? !1 : !0;
      var $frontEndEditorPause = $("body.vc_editor").length > 0 ? !0 : !1;
      var $arrowShape = "";
      var $wrapAround =
      ...
      var $flickity_adaptive_height = !1;
      if ($(this).is('[data-adaptive-height="true"]')) {
        $flickity_adaptive_height = !0;
      }
      var $lazyload =
        $(this).find("img[data-flickity-lazyload]").length > 0 ? 1 : !1;
      if (
        $(this).find("img[data-flickity-lazyload]").length > 0 &&
        $(this).is('[data-overflow="visible"]') &&
        $(this).is('[data-wrap="no-wrap"]')
      ) {
        $lazyload = 2;
      }
      var $flickity_rtl = $body.hasClass("rtl") ? !0 : !1;
      if (
        ($(this).attr("data-controls").length > 0 &&
          $(this).attr("data-controls") == "next_prev_arrows_overlaid") ||
        ($(this).attr("data-controls").length > 0 &&
      ...
      if ($(this).hasClass("nectar-simple-slider")) {
        $flickity_adaptive_height = !1;
        $paginationBool = !1;
        $nextPrevArrowBool = !1;
        $setGallerySizeBool = !1;
        $wrapAround = !1;
        $imagesLoaded = !1;
        $flcikAttr = 0.022;
        ...
        if ($that.find(".flickity-prev-next-button").length == 0) {
          ...
          $that
            ...
            .on("click", function () {
              if (
                ...
                ($flickitySliders[i].isAnimating == !1 ||
                  typeof $flickitySliders[i].isAnimating === "undefined")
              ) {
          ...
          $that
            ...
            .on("click", function () {
              if (
                $wrapAround === !1 &&
                $flickitySliders[i].selectedIndex ==
                  $flickitySliders[i].slides.length - 1 &&
                $flickitySliders[i].isAnimating == !1
              ) {
                var currentX = $flickitySliders[i].x;
                anime({
      ...
      if (
        $(this).hasClass("nectar-simple-slider") &&
        $that.find(".bg-layer[data-nectar-img-src]").length > 0
      ) {
        ...
        $flickitySliders[i].on("scroll", function () {
          $.each($flickitySliders[i].slides, function (i, slide) {
            ...
            if (0 === i) {
              ...
              x =
                Math.abs(flkty.x) + flkty.slides[i].outerWidth <
                flkty.slidesWidth
                  ? slide.target -
                    flkty.slidesWidth +
                    flkty.x -
      ...
      if ($(this).hasClass("nectar-simple-slider") && !0 == $paginationBool) {
        $(this)
        ...
        if ($flickity_stored_autoplay) {
          $(this)
            ...
            .css(
              "transition",
              "stroke-dashoffset " +
                (parseInt($flickity_stored_autoplay) + 100) +
      ...
      if ($(this).is('[data-controls="touch_total"]')) {
        ...
        $window.on("smartresize", function () {
          setTimeout(function () {
            ...
            $totalIndicator.css({ x: $totalPosition + "px" });
          }, 200);
        });
        setTimeout(function () {
          $totalImgs = $that.find(".flickity-page-dots li").length;
      ...
      if (
        ...
        $flickitySliders[i].on("scroll", function () {
          ...
          $flickitySliders[i].slides.forEach(function (slide, j) {
            ...
            flkInstanceSlide
              .find(".inner-wrap")
              .css({ transform: "scale(" + $scaleAmt + ") translateZ(0)" });
          });
        });
      }
    ...
    var $usingNectarCarouselFlk =
      $(".nectar-carousel.nectar-flickity:not(.masonry)").length > 0 ? !0 : !1;
    ...
    var handleCaptions =
      $(".wpb_gallery_slidesflickity_static_height_style .item-meta").length > 0
        ? !0
        : !1;
    if (handleCaptions) {
  ...
  function setNectarFlickityCaptions() {
    $(".wpb_gallery_slidesflickity_static_height_style .item-meta").each(
      function () {
  ...
  function initSF() {
    ...
    $(
      ...
      var $parent = $(this).parent();
      if (
        $parent.find(".item_desc").length > 0 ||
        $parent.find(".nav_desc").length > 0
      ) {
  ...
  function inlineMegaMenuPos() {
    ...
    $(
      ...
      if ($parentEl) {
        if (
          $parentEl.offset().left + $parentEl.width() - $submenu.width() <
          0
        ) {
          $(this).addClass("align-middle");
          return !0;
    ...
    $(
      ...
      if ($parentEl) {
        ...
        if (megaMenuOffset.left < 0) {
          $submenu.css({ right: "auto", left: "0px" });
      ...
      var $that = $(this),
        ...
        colWidth =
          $(this).parents(".carousel-wrap").attr("data-full-width") == "true"
            ? 500
            : 453,
        $autoplayBool = $(this).attr("data-autorotate") == "true" ? !0 : !1,
        $themeSkin = !0,
        $themeSkin2 = !0;
  ...
  function owlCarouselInit() {
    ...
    $(".owl-carousel[data-desktop-cols]").each(function () {
      ...
      var $that = $(this),
        ...
        $owlLoopBool = $that.is('[data-loop="true"]') ? !0 : !1,
        $owlRTL = $body.hasClass("rtl") ? !0 : !1;
      $(this).owlCarousel({
        responsive: {
          0: { items: $(this).attr("data-mobile-cols") },
          690: { items: $(this).attr("data-tablet-cols") },
          1000: { items: $(this).attr("data-desktop-small-cols") },
  ...
  function owl_carousel_animate() {
    $($fullscreenSelector + '.owl-carousel[data-enable-animation="true"]').each(
      function () {
        var $owlOffsetPos =
          $fullscreenMarkupBool == !0 ? "200%" : "bottom-in-view";
  ...
  function productCarouselInit() {
    ...
    $(".nectar-woo-flickity").each(function (i) {
      ...
      var pageDotsBool = $that.is('[data-controls="bottom-pagination"]')
          ? !0
          : !1,
        arrowsBool = $that.is('[data-controls="bottom-pagination"]') ? !1 : !0,
        carouselWrap = !$that.is('[data-wrap="no-wrap"]') ? !0 : !1,
        groupCellsBool = carouselWrap == !0 ? pageDotsBool : !0,
        $autoplay =
      ...
      var relatedUpsell = !1;
      var adaptiveHeight = !1;
      if (
        window.nectarOptions &&
        window.nectarOptions.woo_related_upsell_carousel &&
        window.nectarOptions.woo_related_upsell_carousel == "true" &&
        $(this).hasClass("related-upsell-carousel")
      ) {
        relatedUpsell = !0;
        carouselWrap = !1;
        groupCellsBool = !0;
        if (
          ...
          $(this).find(".products > div").length < 4
        ) {
      ...
      if ($(this).is('[data-controls="touch_indicator"]')) {
        if (!nectarDOMInfo.usingMobileBrowser) {
          flickityDragArr.push(
            new NectarIconMouseFollow($(this), "horizontal-movement")
          );
  ...
  function clientsCarouselInit() {
    ...
    $(".carousel.clients").each(function () {
      var $that = $(this);
      var $autoRotate = !$(this).hasClass("disable-autorotate") ? !0 : !1;
      var columns;
  ...
  function clientsFadeIn() {
    var $clientsOffsetPos = $fullscreenMarkupBool == !0 ? "200%" : "95%";
  ...
  (function (d) {
    ...
    add_event_listener("mousedown", function () {
      if (outlineState.hidden == !1) {
        set_css(":focus{outline:0}::-moz-focus-inner{border:0;}");
        outlineState.hidden = !0;
      }
    });
    add_event_listener("keydown", function () {
      set_css("");
      outlineState.hidden = !1;
    });
  })(document);
        ...
        $parentRow.magnificPopup({
          ...
          callbacks: {
            elementParse: function (item) {
              if (
                ($(item.el).is("[href]") &&
                  $(item.el).attr("href").indexOf("iframe=true") != -1) ||
                ($(item.el).is("[href]") &&
                  $(item.el)
                    .attr("href")
                ...
                $(item.el).is("[href]") &&
                $(item.el).attr("href").indexOf("video-popup-") != -1
              ) {
                item.type = "inline";
              } else {
                item.type = "image";
  ...
  function vcWaypoints() {
    $($fullscreenSelector + " .wpb_animate_when_almost_visible").each(
      function () {
        var $that = $(this),
          $vcOffsetPos = $fullscreenMarkupBool == !0 ? "200%" : "90%",
          waypoint = new Waypoint({
            element: $that,
            handler: function () {
              if (
  ...
  NectarRotatingWords.prototype.viewportTracking = function () {
    ...
    if ("IntersectionObserver" in window) {
      ...
      this.observer = new IntersectionObserver(function (entries) {
        entries.forEach(function (entry) {
          if (entry.isIntersecting) {
            that.state.visible = !0;
          } else {
            that.state.visible = !1;
          }
        });
      }, options);
      this.observer.observe(this.$el[0]);
  ...
  NectarRotatingWords.prototype.calcWidth = function () {
    ...
    this.$el.find(".dynamic-words").css({ width: storedWidth });
    setTimeout(function () {
      that.$el.find(".dynamic-words").css({ width: width });
    }, 30);
  };
  ...
  NectarRotatingWords.prototype.staggerWaypoint = function () {
    var that = this;
    if (
      $fullscreenMarkupBool == !0 &&
      this.$el.parents(".active").length == 0
    ) {
      return !0;
    }
    ...
    var offsetPos = $fullscreenMarkupBool == !0 ? "500%" : "bottom-in-view";
    var $that = this.$el;
    var $delay = $that.is("[data-delay]")
      ? parseInt($that.attr("data-delay"))
      : 0;
    var waypoint = new Waypoint({
      element: $that,
      handler: function () {
        ...
        if (!bypassAnimations || $('body[data-responsive="0"]').length > 0) {
          ...
          setTimeout(function () {
            ...
            $animationDurationCap =
              parseInt($animationDuration) < 1100 ? $animationDuration : "1100";
            var i = 0;
            $that.find(".text-wrap").each(function () {
              var spanEl = $(this);
              if (
                $(this).parents(".dynamic-words").length > 0 &&
                !$(this).hasClass("active")
              ) {
                spanEl.find("> span").css({ transform: "translate3d(0,0,0)" });
                return !0;
              }
              setTimeout(function () {
                spanEl.find("> span").css({ transform: "translate3d(0,0,0)" });
        ...
        if (that.state.sequenceStarted != !0) {
          clearInterval(that.interval);
          that.interval = setInterval(that.sequence.bind(that), that.duration);
        }
        that.state.sequenceStarted = !0;
        waypoint.destroy();
      },
      offset: offsetPos,
    });
  ...
  function milestoneWaypoint() {
    $($fullscreenSelector + ".nectar-milestone").each(function () {
      var $offset = $fullscreenMarkupBool == !0 ? "250%" : "98%";
  ...
  function tabbedChangeSection(clickedTab) {
    ...
    if ($tabbedClickCount != 0) {
      ...
      if (
        $currentVisTab.find(".parallax-layer").length > 0 ||
  ...
  VerticalScrollingTabs.prototype.highlightObserve = function () {
    ...
    if (!(nectarDOMInfo.usingMobileBrowser && nectarDOMInfo.winW < 1000)) {
      if ("IntersectionObserver" in window) {
        var rMarign = $headerOuterEl.is('[data-remove-fixed="1"]')
          ? "100px 0px 0px 0px"
          : "5px 0px 0px 0px";
        var options = { rootMargin: rMarign, threshold: 1 };
        this.observer = new IntersectionObserver(function (entries) {
          entries.forEach(function (entry) {
  ...
  function accordionClickEvents() {
    $body.on("click", ".toggle h3 a", function () {
      if (!$(this).parents(".toggles").hasClass("accordion")) {
        ...
        if (
          $(this).parents(".toggle").find("> div img").length > 0 &&
    ...
    $body.on("click", ".toggles.accordion .toggle h3 a", function (e) {
      ...
      if ($(this).parents('.toggle[data-inner-wrap="true"]').length == 0) {
        ...
        if (
          ...
          setTimeout(function () {
            var $scrollTopDistance =
              $parentToggle.offset().top - nectarDOMInfo.adminBarHeight;
            if ($('#header-outer[data-mobile-fixed="1"]').length > 0) {
              $scrollTopDistance =
                $parentToggle.offset().top -
                $headerOuterEl.outerHeight() -
                nectarDOMInfo.adminBarHeight;
            }
  ...
  NectarStickyEls.prototype.calcTopOffset = function () {
    if (
      ...
      this.topOffset =
        parseInt($headerNavSpace) + resize + nectarDOMInfo.adminBarHeight;
  ...
  NectarStickyEls.prototype.resizeEvent = function () {
    if (nectarDOMInfo.winW > 1000) {
      this.calcTopOffset();
      $(this.selectors).css({ position: "sticky", top: this.topOffset });
    } else {
      $(this.selectors).css({ position: "", top: "" });
    }
  };
  ...
  function coloredButtons() {
    $(
      ...
      var $usingMaterialSkin =
        $('body.material[data-button-style^="rounded"]').length > 0 ? !0 : !1;
      ...
      function () {
        ...
        var $usingBoxedClass = $("body > #boxed").length > 0 ? "in-boxed" : "",
          ...
          $teamMemberTitle = $(this).is('[data-style="bio_fullscreen_alt"]')
            ? $(this).find(".team-meta h5").text()
            : $(this).find(".team-meta p").text(),
          $teamMemberImg =
  ...
  function columnBGColors() {
    ...
    $(".wpb_column").each(function (i) {
      ...
      if (
        $(this).attr("data-has-bg-color") == "true" ||
  ...
  function svgAnimations() {
    var $svgOffsetPos = $fullscreenMarkupBool == !0 ? "500%" : "bottom-in-view";
    ...
    var $windowInnerWidth = nectarDOMInfo.winW,
      ...
      $container_width =
        $(".container-wrap").length > 0
          ...
          : $window.width(),
      $extended_padding =
        $("body[data-ext-padding]").length > 0
          ? parseInt($("body").attr("data-ext-padding")) * 2
          : 180;
  ...
  NectarParallaxScroll.prototype.setup = function () {
    ...
    if (
      ...
      (this.$el.parents(".top-level").length > 0 &&
        ...
        this.$el.parent().parent().is(".vc_col-sm-12:not(.child_column)")) ||
    ...
    setInterval(function () {
      if (nectarState.materialOffCanvasOpen != !0) {
        that.offsetTop = that.$el.offset().top;
        that.height = that.$el.outerHeight(!0);
      }
    }, 800);
    $(window).on(
  ...
  NectarParallaxScroll.prototype.update = function () {
    if (
      this.offsetTop + this.height < nectarDOMInfo.scrollTop ||
      this.offsetTop > nectarDOMInfo.scrollTop + nectarDOMInfo.winH ||
      nectarState.materialOffCanvasOpen == !0
    ) {
    ...
    for (var i = 0; i < this.$parallaxEl.length; i++) {
      if (this.firstSection === !0) {
        this.$parallaxEl[i].style.transform =
          "translate3d(0, " +
          parseInt(nectarDOMInfo.scrollTop * this.speed) +
          "px, 0)";
      } else {
        this.$parallaxEl[i].style.transform =
          "translate3d(0, " +
          parseInt(
            (this.storedWinH + nectarDOMInfo.scrollTop - this.offsetTop) *
              this.speed
          ) +
          "px, 0) scale(1.005)";
      }
  ...
  function parallaxScrollInit() {
    ...
    $(
      ...
      if ($(this).is("[data-n-parallax-bg][data-parallax-speed]")) {
        parallaxItemsArr[parallaxItemCount] = new NectarParallaxScroll(
          $(this),
          ".parallax-layer",
          parallaxSrollSpeed($(this).attr("data-parallax-speed")),
          "regular"
        );
        parallaxItemCount++;
      } else {
        if ($(this).find('[data-parallax-speed="fixed"]').length == 0) {
          if ($(this).hasClass("nectar-slider-wrap")) {
            ...
            $(this).parents("#page-header-bg").length > 0
          ) {
            parallaxItemsArr[parallaxItemCount] = new NectarParallaxScroll(
              $(this),
              ".nectar-video-bg",
  ...
  function parallaxRowsBGCals() {
    ...
    $(
      ...
      if (
        $(this).parents(".wpb_tab:not(.visible-tab)").length > 0 ||
        ($(this).parents(".wc-tab").length > 0 &&
          $(this).parents(".wc-tab").css("display") !== "block")
      ) {
        return !0;
      }
      if (
        ...
        if (
          ...
          $(this)
            ...
            .css({
              height:
                Math.ceil($window.height() * 0.25) + $(this).outerHeight(!0),
            });
        }
      } else if (
        $(this).find(".row-bg").length == 0 &&
        ...
        if (
          ...
          nectarDOMInfo.usingFrontEndEditor ||
          $(this).find(".parallax-layer").length > 0
        ) {
          var classSelector = ".row-bg";
          var parallaxSpeed = $(this)
            .find(".row-bg")
            .attr("data-parallax-speed");
          if ($(this).find(".parallax-layer").length > 0) {
            classSelector = ".parallax-layer";
            parallaxSpeed = $(this).attr("data-parallax-speed");
          }
          var $ifFast =
            $(this).find(classSelector + '[data-parallax-speed="fast"]')
              .length > 0
              ? 60
              : 0;
          $(this)
            ...
            .css({
              height:
                Math.ceil(
                  $window.height() * parallaxSrollSpeed(parallaxSpeed)
                ) +
                $(this).outerHeight(!0) +
                $ifFast,
            });
  ...
  function mouseParallaxInit() {
    $(".wpb_row:has(.nectar-parallax-scene)").each(function (i) {
      ...
      $mouseParallaxScenes[i] = $(this)
        ...
        .parallax({ scalarX: $strength, scalarY: $strength });
  ...
  function rowBGAnimations() {
    var $rowBGAnimationsOffsetPos =
      $fullscreenMarkupBool == !0 ? "500%" : "93%";
    var $rowBGAnimationsRevealOffsetPos =
      $fullscreenMarkupBool == !0 ? "500%" : "97%";
    var $rowBGOffset;
    $(
      $fullscreenSelector +
  ...
  function colAndImgAnimations() {
    var $colAndImgOffsetPos = $fullscreenMarkupBool == !0 ? "500%" : "88%";
    var $cascadingOffsetPos = $fullscreenMarkupBool == !0 ? "500%" : "70%";
    var $colAndImgRevealOffsetPos =
      $fullscreenMarkupBool == !0 ? "500%" : "70%";
          ...
          handler: function () {
            ...
            if (
              ...
              var $columnInnerSelector =
                $that.find("> .vc_column-inner").length > 0 ? !0 : !1;
              if (
  ...
  function cascadingImageBGSizing() {
    $(".nectar_cascading_images").each(function () {
      var forcedAspect = $(this).hasClass("forced-aspect") ? !0 : !1;
      if (
      ...
      $(this)
        ...
        .each(function () {
          if (
            forcedAspect == !0 &&
            $(this).parents(".cascading-image").index() == 0
          ) {
            return !0;
          }
          var $bgColorHeight = 0;
          ...
          $(this)
            .css({ height: $bgColorHeight, width: $bgColorWidth })
            .addClass("calculated");
        });
    });
  }
  ...
  CascadingParallax.prototype.animate = function () {
    ...
    if (this.inView) {
      ...
      this.$element.find(".bg-layer").each(function (i) {
        ...
        if (that.topLevel === !0 && nectarDOMInfo.winW > 1000) {
  ...
  function splitLineHeadings() {
    var $splitLineOffsetPos =
      $fullscreenMarkupBool == !0 ? "500%" : "bottom-in-view";
          ...
          if (!bypassAnimations || $('body[data-responsive="0"]').length > 0) {
            ...
            setTimeout(function () {
              if ($that.is('[data-animation-type="line-reveal-by-space"]')) {
                ...
                $animationDurationCap =
                  parseInt($animationDuration) < 1100
                    ? $animationDuration
                    : "1100";
                if (
                  $that.is('[data-m-rm-animation="true"]') &&
                  nectarDOMInfo.winW < 1000
                ) {
                  $that
                    .find("> * > span .inner")
    ...
    $($progressSelector).each(function () {
      ...
      var waypoint = new Waypoint({
        ...
        handler: function () {
          ...
          $that
            .find("span")
            .transition({ width: percent + "%" }, 800, "easeInOutCubic");
          var countOptions = { useEasing: !1 };
  ...
  function animatedColBorders() {
    var $progressBarsOffsetPos = $fullscreenMarkupBool == !0 ? "500%" : "75%";
  ...
  function foodMenuItems() {
    var $foodItemOffsetPos = $fullscreenMarkupBool == !0 ? "500%" : "80%";
        ...
        waypoint = new Waypoint({
          ...
          handler: function () {
            ...
            $that.each(function () {
              ...
              var $that = $(this);
              $that
                .delay($that.attr("data-animation-delay"))
                .transition(
                  { transform: "scale(1, 1)" },
                  $lineDur,
        ...
        .each(function () {
          if (nectarDOMInfo.winW > 690) {
            ...
            if ($tipOffset.left < 0) {
              ...
              $tipOffset.left + $(this).find(".nttip").outerWidth(!0) >
              nectarDOMInfo.winW
            ) {
              $(this)
                .find(".nttip")
  ...
  NectarPostGrid.prototype.lightboxGroups = function () {
    var unique_id = uniqueIdGenerate();
    var usingLightbox =
      this.el.find(".nectar-post-grid-link.pretty_photo").length > 0 ? !0 : !1;
  ...
  function NectarPostGridWaypoint() {
    var postGridOffsetPos = $fullscreenMarkupBool == !0 ? "200%" : "75%";
  ...
  function wooProductCarouselAnimations() {
    var $wooProductOffsetPos = $fullscreenMarkupBool == !0 ? "500%" : "75%";
    $(
      $fullscreenSelector + '.nectar-woo-flickity[data-animation*="fade-in"]'
    ).each(function () {
      var $that = $(this),
        waypoint = new Waypoint({
          element: $that,
          handler: function () {
            ...
            $that.find(".flickity-cell").each(function (i) {
              var $el = $(this);
              setTimeout(function () {
                $el.css({ transform: "translate3d(0,0,0)", opacity: "1" });
              }, i * 100);
            });
            waypoint.destroy();
          },
  ...
  function iconList() {
    var $iconListOffsetPos = $fullscreenMarkupBool == !0 ? "250%" : "75%";
  ...
  function videoBGInit() {
    ...
    setTimeout(function () {
      ...
      $(".nectar-video-wrap").each(function () {
        ...
        var $headerVideo =
          $(this).parents("#page-header-bg").length > 0 ? !0 : !1;
        var $that = $(this);
  ...
  function mobileNavMegamenuCorrect() {
    ...
    $($mobileNavSelector + ".menu-item > ul > li > a").each(function () {
      if (
        ...
        $(this).text() == "–" ||
        $(this).parent().hasClass("hide-title") ||
        $(this).find("> .remove-menu-item-title").length > 0
      ) {
  ...
  function calculateHoverNavMinHeight() {
    ...
    if (
      $offCanvasEl.height() -
        25 -
        $(".bottom-meta-wrap").outerHeight(!0) -
        $widgetHeights >
  ...
  function OCM_slideOutRightHoverOpen() {
    ...
    if (nectarDOMInfo.usingMobileBrowser) {
      ...
      $offCanvasBG.css({ height: "100%", width: "100%" });
    }
    ...
    var alignmentPosition =
      window.nectarOptions &&
      window.nectarOptions.mobile_header_format &&
      window.nectarOptions.mobile_header_format === "centered-menu" &&
    ...
    if (
      ...
      var $withinCustomBreakpoint = mobileBreakPointCheck();
      if (
        $('#header-outer[data-format="centered-menu-bottom-bar"]').length > 0
      ) {
        $withinCustomBreakpoint = !1;
      }
  ...
  function OCM_slideOutRightHoverCloseCheck(e) {
    ...
    if (conditionalShow && $offCanvasEl.hasClass("mouse-accessed")) {
      ...
      $offCanvasEl.css({ transform: "" }).removeClass("open");
  ...
  function OCM_mobileSlideOutRightHoverCloseCheck() {
    if (nectarDOMInfo.usingMobileBrowser) {
      ...
      $offCanvasBG.css({ height: "1px", width: "1px" });
    }
    $offCanvasEl.css({ transform: "" }).removeClass("open");
    $headerOuterEl.removeClass("style-slide-out-from-right");
    $(".slide-out-hover-icon-effect .lines-button")
    ...
    if ($("body.material").length == 0) {
      ...
      if (
        ...
        $headerOuterEl
          .stop(!0)
          .transition(
            { x: "0px", "background-color": $currentRowBG },
            700,
            "easeInOutCubic"
          );
      } else {
        $headerOuterEl.stop(!0).transition({ x: "0px" }, 700, "easeInOutCubic");
      }
      $offCanvasEl
        .stop(!0)
        .transition(
      ...
      setTimeout(function () {
        ...
        nectarState.materialOffCanvasOpen = !1;
      }, 900);
      setTimeout(function () {
        $(
          '#header-outer:not([data-format="left-header"]) header#top .slide-out-widget-area-toggle a'
  ...
  function OCM_fullscreenOpen() {
    ...
    $headerOuterEl.stop(!0).css("transform", "translateY(0)");
    setTimeout(function () {
    ...
    var headerOffset =
      $headerOuterEl.offset().top -
      nectarDOMInfo.scrollTop +
      nectarDOMInfo.secondaryHeaderHeight;
    $("#slide-out-widget-area.fullscreen .inner-wrap").css(
      "padding-top",
      $headerOuterEl.outerHeight() + headerOffset
    );
  }
  function OCM_fullscreenClose() {
    ...
    setTimeout(function () {
      ...
      $("#slide-out-widget-area.fullscreen .inner .menu-wrap").css(
        "height",
        "auto"
      );
    }, 800);
    ...
    $offCanvasBG
      .stop(!0)
      .transition({ opacity: 0 }, 900, "easeOutQuad", function () {
        if (
        ...
        $(this)
          .css({ height: "1px", width: "1px", opacity: $opacity })
          .transition({ y: "-100%" }, 0);
      });
  }
  function OCM_fullscreenAltOpen() {
    ...
    if ($("#header-outer.transparent").length > 0) {
      if ($bodyBorderTop.length > 0) {
        $(".admin-bar #slide-out-widget-area-bg" + $ocm_fullscreen_class).css({
          "padding-top": $bodyBorderTop.outerHeight(!0) + 32 + "px",
        });
        $(
          "body:not(.admin-bar) #slide-out-widget-area-bg" +
            $ocm_fullscreen_class
        ).css({ "padding-top": $bodyBorderTop.outerHeight(!0) + "px" });
      }
    }
    $headerOuterEl.stop(!0).css("transform", "translateY(0)");
    if (
    ...
    if ($ocm_fullscreen_class === ".fullscreen-alt") {
      $offCanvasBG
        ...
        .css({ height: "100%", width: "100%", left: "0", opacity: $opacity });
      OCM_overflowState();
    }
    setTimeout(function () {
      $(".slide-out-widget-area-toggle > div > a").removeClass("animating");
  ...
  function OCM_fullscreenAltClose() {
    ...
    setTimeout(function () {
      if ($ocm_fullscreen_class === ".fullscreen-alt") {
        ...
        $("#slide-out-widget-area.fullscreen-alt .inner .menu-wrap").css(
          "height",
          "auto"
        );
    ...
    var borderDelay = $bodyBorderHeaderColorMatch == !0 ? 150 : 50;
    setTimeout(function () {
      if ($ocm_fullscreen_class === ".fullscreen-alt") {
        $offCanvasBG.stop(!0).css({ opacity: 0 });
      }
    ...
    setTimeout(function () {
      $(
        '#header-outer:not([data-permanent-transparent="1"]).transparent.small-nav, #header-outer[data-hhun="1"]:not([data-permanent-transparent="1"]).transparent.scrolling, #header-outer:not([data-permanent-transparent="1"]).transparent.scrolled-down'
      ).removeClass("transparent");
      if ($headerOuterEl.hasClass("pseudo-data-transparent")) {
        $headerOuterEl
          .attr("data-transparent-header", "false")
  ...
  function OCM_simpleDropdownOpen(classname) {
    $("#mobile-menu").show();
    $("header#top")
      .find("." + classname + ":not(.std-menu) .lines-button")
      .addClass("close");
    if ($("body.material").length > 0) {
      $("header#top")
        .find("." + classname + " a")
  ...
  function OCM_simpleStyleInit() {
    ...
    $("#header-outer #mobile-menu ul li a").each(function () {
      if (
        ...
        $(this).find(".nectar-ext-menu-item").length == 0
      ) {
    ...
    $window.on("smartresize", function () {
      if (
        ...
        (nectarDOMInfo.winW > 1000 &&
          $(".nectar-ocm-trigger-open.simple-mobile-menu a.open").length > 0)
      ) {
        $(
  ...
  function clickToggleSubmenus() {
    ...
    var left_header_selector =
      '#header-outer[data-format="left-header"] nav li.menu-item-has-children > a';
    var lh_dropdown_func =
      window.nectarOptions && window.nectarOptions.left_header_dropdown_func
        ? window.nectarOptions.left_header_dropdown_func
        : "default";
    if (lh_dropdown_func === "separate-dropdown-parent-link") {
      left_header_selector =
        '#header-outer[data-format="left-header"] nav li.menu-item-has-children > a .sf-sub-indicator';
    }
    $(left_header_selector + ", " + $ocm_link_selector).on(
      "click",
      function () {
        ...
        if ($parentSelector.hasClass("open-submenu")) {
          $parentSelector.find(".sub-menu").css({ "max-height": "0" });
    ...
    if (
      ...
      if (lh_dropdown_func === "separate-dropdown-parent-link") {
        $(
          '#header-outer[data-format="left-header"] nav .sf-menu > .current-menu-ancestor.menu-item-has-children > a .sf-sub-indicator'
        ).trigger("click");
      } else {
        $(
      ...
      this.$menuitems.on("click.menu", function (event) {
        ...
        if ($submenu.length > 0) {
          ...
          $item
            ...
            .transition({ height: $flyin.height() }, 500, "easeInOutQuad");
  ...
  function pageHeaderInit() {
    ...
    if ($('#page-header-bg[data-parallax="1"]').length > 0) {
      var img = new Image(),
        ...
        globalTopSectionHeight =
          $(".nectar-global-section.after-nav").length > 0
    ...
    function parallaxPageHeaderCalc() {
      ...
      if (
        ...
        if (pageHeaderState.inView == !0) {
          $pageHeaderInnerEl.css({
            transform:
              "translateY(" + nectarDOMInfo.scrollTop * $multiplier + "px)",
            opacity:
              1 -
              nectarDOMInfo.scrollTop /
                ((globalTopSectionHeight + pageHeaderHeight) * 0.7),
          });
          if ($pageHeaderCanvasEl) {
            $pageHeaderCanvasEl.css({
              transform:
                "translateY(" +
                nectarDOMInfo.scrollTop * $multiplier * 2 +
                "px)",
            });
          }
        }
  ...
  function nectarBoxRollInit() {
    if (
      ...
      $(window).on("nectar-box-roll-scroll-disabled", function () {
        nectarState.preventScroll = !0;
      });
      $(window).on("nectar-box-roll-scroll-enabled", function () {
        nectarState.preventScroll = !1;
      });
  ...
  NectarWooCommerceFilters.prototype.toggle = function () {
    ...
    if (this.state.open == "true") {
      ...
      this.$toggleBtn.find(".top-line").css({ transform: "translateX(10px)" });
      this.$toggleBtn
        .find(".bottom-line")
  ...
  function NectarWooCommerceQuantity() {
    ...
    this.state = { max: 100000, min: 0, currentVal: 1, key: 0, removeFlag: !1 };
    this.events();
  }
  NectarWooCommerceQuantity.prototype.updateState = function (el) {
    var key = 0;
    if (!0 === this.checkMiniCart(this.$qty)) {
    ...
    this.state = { currentVal: currentVal, max: max, min: min, key: key };
  };
  NectarWooCommerceQuantity.prototype.events = function () {
    ...
    $("body").on(
      ...
      function (e) {
        ...
        if (
          that.state.min &&
          (that.state.min == that.state.currentVal ||
            that.state.currentVal < that.state.min)
        ) {
          that.state.removeFlag = !0;
        }
        $(this).trigger("change");
      }
    );
    $("body").on(
      ...
      ".woocommerce-mini-cart .quantity .qty",
      function (e) {
        if (!e.originalEvent && !0 === that.checkMiniCart(that.$qty)) {
  ...
  NectarWooCommerceQuantity.prototype.checkMiniCart = function (el) {
    return el.parents(".woocommerce-mini-cart").length > 0 ? !0 : !1;
  };
      ...
      $.ajax({
        ...
        success: function (response) {
          if (response) {
            ...
            var $subtotal = that.$qty
              .closest(".widget_shopping_cart_content")
              .find(".woocommerce-mini-cart__total");
            $subtotal.find(".woocommerce-Price-amount").remove();
            $subtotal.append(response.subtotal);
            if (that.state.removeFlag === !0) {
              that.$qty.closest(".woocommerce-mini-cart-item").remove();
              that.state.removeFlag = !1;
              $(document.body).trigger("updated_wc_div");
            }
            if ($("#header-outer a.cart-contents .cart-wrap span").length > 0) {
              $("#header-outer a.cart-contents .cart-wrap span").text(
                response.item_count
              );
            }
          }
  ...
  NectarWooCommerceCartAJAX.prototype.addNotices = function (notices) {
    ...
    $.each(notices, function (k, item) {
      $noticeParent.prepend(
        '<div class="nectar-notice">' + item.notice + "</div>"
      );
    });
    setTimeout(function () {
  ...
  NectarWooCommerceCartAJAX.prototype.addToCartAJAX = function (e) {
    ...
    if (
      $wooForm.closest(".product").hasClass("product-type-external") ||
    ...
    e.preventDefault();
    if (that.state.processing == !0) {
      return;
    }
    that.state.processing = !0;
    that.state.productID = !1;
    ...
    if (that.state.productID === !1 && $addToCartBtn.length > 0) {
      regID = $addToCartBtn.val().match(/\d+/);
      if (regID && regID[0]) {
        that.state.productID = regID[0];
      }
    }
    if (that.state.productID === !1) {
    ...
    $formData.push(
      ...
      { name: "add-to-cart", value: that.state.productID }
    );
    $.ajax({
      type: "POST",
      url: window.nectarLove.ajaxurl,
  ...
  function wooCommerceEvents() {
    ...
    var bindTextOnHoverMobile =
      $('.products[data-rm-m-hover="1"]').length > 0 &&
      nectarDOMInfo.usingMobileBrowser
        ? !1
        : !0;
    ...
    if (
      ...
      if (
        window.nectarOptions &&
        window.nectarOptions.woo_minimal_product_effect &&
        window.nectarOptions.woo_minimal_product_effect === "default"
      ) {
    ...
    function minimalProductCalc(el) {
      ...
      var $item = el,
        ...
        $wChange =
          (parseInt($itemWidth) + expansionAmtX) / parseInt($itemWidth),
        $hChange =
          (parseInt($itemHeight) + expansionAmtY) / parseInt($itemHeight);
    ...
    $body.on(
      ...
      function () {
        if (
          window.nectarOptions &&
          window.nectarOptions.woo_sidebar_toggles !== "false"
        ) {
          if ($window.width() < 1000) {
            ...
            if (
              ...
              $(this)
                .parent()
                .find("> .woocommerce-widget-layered-nav-dropdown").length > 0
            ) {
              $(this)
                .parent()
    ...
    function closeCartCheck(e) {
      var $windowWidth = $window.width();
      if (
        e.clientX < $windowWidth - 370 - $bodyBorderWidth &&
    ...
    if (
      window.nectarOptions &&
      window.nectarOptions.woo_product_filter_toggle === "1" &&
      $body.is(".archive.woocommerce")
    ) {
  ...
  NectarQuickSearch.prototype.getResults = function () {
    ...
    this.request = $.ajax({
      type: "POST",
      url: window.nectarLove.ajaxurl,
      data: { action: "nectar_ajax_ext_search_results", search: val },
      cache: !1,
      success: function (response) {
        that.state.requesting = !1;
        if (!response) {
          that.resetHeight();
        }
        if (
          ...
          that.$searchEl.hasClass("material-open")
        ) {
          ...
          if (
            nectarDOMInfo.winW >= 1000 &&
            !$headerOuterEl.hasClass("results-shown")
          ) {
            that.$container
            ...
            that.$container
              ...
              .each(function (i) {
                var $that = $(this);
                setTimeout(function () {
                  $that.css({ opacity: "1", transform: "translateY(0)" });
                }, 50 + i * 60);
              });
          }
          that.state.open = !0;
  ...
  function navigationSearchInit() {
    ...
    if (
      window.nectarOptions &&
      window.nectarOptions.quick_search &&
      window.nectarOptions.quick_search === "true"
    ) {
    ...
    $body.on(
      ...
      function () {
        ...
        if (
          ...
          nectarState.materialSearchOpen = !0;
    ...
    function closeSearch() {
      if (
        ...
        $("#search-outer")
          .stop()
          .transition({ opacity: 0 }, 300, "cubic-bezier(0.2, 1, 0.3, 1)");
      ...
      if ($body.hasClass("material")) {
        ...
        var closeTimeoutDur = $headerOuterEl.hasClass("results-shown")
          ? 800
          : 400;
        setTimeout(function () {
          $("#search-outer #s").val("");
        ...
        nectarState.materialSearchOpen = !1;
  ...
  function centeredNavBottomBarReposition() {
    ...
    if ($('#header-outer[data-condense="true"]').length > 0) {
      ...
      $window.on("smartresize", function () {
        ...
        if (nectarDOMInfo.winW >= 1000 && !1 == mobileBreakPointCheck()) {
    ...
    function centeredNavBottomFixed_Scroll() {
      ...
      if (
        ...
        if (!$headerOuter.is('[data-menu-bottom-bar-align="left"]')) {
          var $headerNavBarOffset =
            $("header#top .span_9 nav > ul").length > 0
              ? $("header#top .span_9 nav > ul").offset().top
              : 0;
          var $headerButtonsOffset =
            $headerBtns.find("li:first-child > *").length > 0
              ? $headerBtns.find("li:first-child > *").offset().top
              : 0;
          var $headerButtonsHeight =
            $headerSpan9.find(".sf-menu > li > a").length > 0
              ? (20 -
                  parseInt($headerSpan9.find(".sf-menu > li > a").height())) /
                2
              : 2;
          $headerBtns.css(
            "transform",
  ...
  function hhunHeaderEffect() {
    var previousScroll = 0,
      ...
      hideShowOffset = 3,
      stickyPageSubmenu =
        $('.page-submenu[data-sticky="true"]').length > 0 ? !0 : !1,
      bodyOffsetHeight = document.body.offsetHeight;
    function getBodyHeight() {
      if (nectarDOMInfo.winW > 999 && nectarState.materialOffCanvasOpen != !0) {
        bodyOffsetHeight = document.body.offsetHeight;
      }
    }
    ...
    function hhunCalcs() {
      ...
      if (
        (nectarState.animatedScrolling == !0 &&
        ...
        if (nectarDOMInfo.winW > 999) {
          if (currentScroll > menuOffset) {
            if (
              nectarState.animatedScrolling == !0 &&
              headerTransparent == !0 &&
              nectarState.permanentTransHeader == !1
            ) {
      ...
      if (
        ...
        if (nectarDOMInfo.winW > 999) {
          if (nectarState.materialSearchOpen == !0 && headerTransparent == !0) {
            if (
              nectarState.permanentTransHeader == !1 &&
              currentScroll > menuOffset
            ) {
              $headerOuterEl.removeClass("transparent").addClass("scrolling");
            } else {
      ...
      if (headerMobileFixed == !1 && nectarDOMInfo.winW < 1000) {
      ...
      if (
        ...
        if (currentScroll > menuOffset) {
          if (nectarState.permanentTransHeader == !1) {
            if (hhunState.timeoutQueued == !1) {
              setTimeout(function () {
                $headerOuterEl.removeClass("transparent");
                $headerOuterEl.addClass("scrolling");
                hhunState.timeoutQueued = !1;
              }, 400);
            }
  ...
  function bindScrollEffectsDesktop() {
    ...
    if (headerResize == !0 && headerHideUntilNeeded != "1") {
      $window.off("scroll.headerResizeEffect");
      if ($("#nectar_fullscreen_rows").length == 0) {
        $window.on("scroll.headerResizeEffect", smallNav);
      } else if (
  ...
  function headerNavOffsetInit() {
    ...
    function headerOffsetAdjustCalc() {
      ...
      if (
        nectarDOMInfo.winW < 1000 ||
        (condenseHeaderLayout == !0 &&
          $("#header-outer .span_9").css("display") == "none") ||
        (condenseHeaderLayout == !0 &&
          $("#header-outer .span_9 > nav").css("display") == "none")
      ) {
        $eleHeight = 0;
        var $endOffset =
  ...
  function footerRevealCalcs() {
    ...
    if (
      ...
      ).css({ "margin-bottom": nectarDOMInfo.footerOuterHeight });
      $(".container-wrap").css({
        "min-height":
          nectarDOMInfo.winH -
          nectarDOMInfo.adminBarHeight -
  ...
  function stickyPageSubmenuInit() {
    ...
    function Sticky(options) {
      ...
      this.createWrapper();
      this.topLevel =
        $(this.element).parents(".top-level").length > 0 ? !0 : !1;
      this.createWaypoint();
    }
    Sticky.prototype.createWaypoint = function () {
      ...
      if (
        this.topLevel &&
        $('body[data-hhun="1"] #header-outer.detached:not(.invisible)').length >
          0
      ) {
        $offsetHeight += 1;
  ...
  function fixIE11Images() {
    $(".img-with-aniamtion-wrap img.img-with-animation").each(function () {
      if (
        ...
        $parentWrap.css({ height: "" });
        var height = $(this).height();
        $parentWrap.css({ height: height });
      }
    });
  }
  ...
  function parallaxItemHoverEffect() {
    ...
    for (var l = 0; l < totalImgs; l++) {
        ...
        (function (_thisImg, _layers, _totalLayers, _shine) {
          $(thisImg)
            ...
            .on("mousemove", function (e) {
              ...
              var now = Date.now();
              var usingGallery =
                $(_thisImg).parents(".wpb_gallery").length > 0 ? !0 : !1;
      ...
      (function (_thisImg, _layers, _totalLayers, _shine) {
        depths(!1, _thisImg, _layers, _totalLayers, _shine);
    ...
    $("body").on(
      ...
      function () {
        $hoverContentHeight = parseInt(
          $(this).find(".hover-content").outerHeight(!0)
        );
  ...
  NectarMouseFollowIcon.prototype.mouseEvents = function () {
    ...
    $(window).on("scroll", function () {
      if (that.activeFollow == !0 && that.lastScroll == 0) {
        that.lastScroll = nectarDOMInfo.scrollTop;
      }
    });
  };
  NectarMouseFollowIcon.prototype.rafLoop = function () {
    if (this.activeFollow == !0) {
      this.scrollAdjust =
        ...
        $(this).imagesLoaded(function () {
          ...
          if ($that.is('[data-mouse-style="solid_color"]')) {
            $that
              ...
              .css({ "background-color": $playColor });
          }
      ...
      $(".portfolio-items.infinite_scroll").infinitescroll(
        ...
        function (newElements) {
          ...
          $newElems.imagesLoaded(function () {
            ...
            $(newElements)
              .find(".work-meta, .nectar-love-wrap")
              .css({ opacity: 1 });
            if (
              $(".portfolio-filters-inline").length > 0 ||
              $(".portfolio-filters").length > 0
      ...
      $body.on(
        ...
        function (e) {
          ...
          $animatedScrollingTimeout = setTimeout(function () {
            ...
            nectarState.animatedScrolling = !1;
          }, 850);
          var $headerNavSpace =
            $('body[data-header-format="left-header"]').length > 0 &&
            $window.width() > 1000
  ...
  function masonryPortfolioInit() {
    ...
    $(".portfolio-items:not(.carousel)").each(function (i) {
      if (
        $(this).parents(".wpb_gallery").length > 0 &&
        $(this).find(".nectar-lazy").length > 0
      ) {
        $(this)
          .find(".col")
          .each(function (i) {
      ...
      if (typeof SalientPortfolio !== "undefined") {
        $portfolio_containers[portfolioElCount] = new SalientPortfolio(
          $(this),
          fullWidthContentColumns
        );
        portfolioElCount++;
  ...
  function stickySidebarInit() {
    ...
    if (
      window.nectarOptions &&
      window.nectarOptions.woo_sticky_sidebar &&
      window.nectarOptions.woo_sticky_sidebar === "1"
    ) {
        ...
        if ($('body[data-permanent-transparent="1"]').length == 0) {
          if (!$body.hasClass("mobile")) {
            if (
              ...
              nectar_scrollToY(
                parseInt($topDistance) + $offset + 2 - $bodyBorderSize * 2,
                700,
                "easeInOutQuint"
              );
            } else {
  ...
  function select2Init() {
    $(
      ...
      if ($(this).parents("#buddypress").length == 0) {
        var woo_product_dropdown_style =
          window.nectarOptions &&
          window.nectarOptions.woo_product_variable_select
            ? window.nectarOptions.woo_product_variable_select
            : "default";
        ...
        if (
          woo_product_dropdown_style == "underline" ||
  ...
  function pageTransitionInit() {
    var mobileDisabledCondition = !1;
    if (
      $('body[data-ajax-transitions="true"]').length > 0 &&
      $('#ajax-loading-screen[data-disable-mobile="1"]').length > 0 &&
      nectarDOMInfo.winW < 1000
    ) {
      mobileDisabledCondition = !0;
    }
    if (
      $('body[data-ajax-transitions="true"]').length > 0 &&
      $('#ajax-loading-screen[data-method="standard"]').length > 0 &&
      mobileDisabledCondition == !1
    ) {
      ...
      if (
        ...
        window.onunload = function () {
          $("#ajax-loading-screen")
            .stop()
            .transition({ opacity: 0 }, 800, function () {
              $(this).css({ display: "none" });
            });
          $("#ajax-loading-screen .loading-icon").transition(
            { opacity: 0 },
